...
import { geolocation, geolocation2, geolocation3, geolocation4 } from 'src/seed';
  ...
  async seedGeoLocations(geolocations ){
    const newGeoLocations = geolocations.map((geolocation) => {
      return {
        ...
        municipality : geolocation.municipality ==="N/A"?null: geolocation.municipality,
        state_district : geolocation.state_district ==="N/A"?null: geolocation.state_district,
        administrative : geolocation.administrative ==="N/A"?null: geolocation.administrative,
