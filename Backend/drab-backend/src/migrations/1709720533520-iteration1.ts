...
export class Iteration11709720533520 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "customerId" integer, CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "weatherstation_data" ADD CONSTRAINT "FK_f00e07048e5102db74c580355aa" FOREIGN KEY ("weatherstationId", "weatherstationName") REFERENCES "weatherstation"("id","name") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "nearest_location" ADD CONSTRAINT "FK_a5753002f9160f69a7e05823a6d" FOREIGN KEY ("weatherstationId", "weatherstationName") REFERENCES "weatherstation"("id","name") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "geolocation" ADD CONSTRAINT "FK_474939ecc461bbca3a08513776f" FOREIGN KEY ("weatherstationId", "weatherstationName") REFERENCES "weatherstation"("id","name") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "geolocation" DROP CONSTRAINT "FK_474939ecc461bbca3a08513776f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "nearest_location" DROP CONSTRAINT "FK_25cd5af4ae8c78b8e43481bd242"`,
    );
    await queryRunner.query(
      `ALTER TABLE "nearest_location" DROP CONSTRAINT "FK_a5753002f9160f69a7e05823a6d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscription" DROP CONSTRAINT "FK_e4543f99d629cf2c04fe9332e30"`,
    );
    await queryRunner.query(
      `ALTER TABLE "weatherstation_data" DROP CONSTRAINT "FK_f00e07048e5102db74c580355aa"`,
    );
