...
export class Iteration11709727864130 implements MigrationInterface {
    name = 'Iteration11709727864130'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "weatherstation_data" ("id" SERIAL NOT NULL, "datetime" TIMESTAMP NOT NULL, "temp" numeric(6,2) NOT NULL, "dew_point" numeric(6,2) NOT NULL, "s_airpressure" numeric(6,2) NOT NULL, "sea_airpressure" numeric(6,2) NOT NULL, "visibility" numeric(6,2) NOT NULL, "windspeed" numeric(6,2) NOT NULL, "precipitation" numeric(6,2) NOT NULL, "snow_amount" numeric(6,2) NOT NULL, "freezing" boolean NOT NULL DEFAULT false, "rain" boolean NOT NULL DEFAULT false, "snow" boolean NOT NULL DEFAULT false, "hail" boolean NOT NULL DEFAULT false, "thunder" boolean NOT NULL DEFAULT false, "tornado" boolean NOT NULL DEFAULT false, "clouds" numeric(6,2) NOT NULL, "wind_direction" integer NOT NULL, "weatherstationName" character varying, CONSTRAINT "PK_bd4033afa8f7eb584300e899e18" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "weatherstation_data" ADD CONSTRAINT "FK_a8a412d51021dda51b7f234365e" FOREIGN KEY ("weatherstationName") REFERENCES "weatherstation"("name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "weatherstation_data" DROP CONSTRAINT "FK_a8a412d51021dda51b7f234365e"`);
