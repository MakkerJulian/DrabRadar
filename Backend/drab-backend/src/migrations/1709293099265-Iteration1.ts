...
export class Iteration11709293099265 implements MigrationInterface {
    name = 'Iteration11709293099265'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "weatherstation" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "longitude" integer NOT NULL, "latitude" integer NOT NULL, "elevation" integer NOT NULL, CONSTRAINT "PK_8b3d2b285b0adf69cdafd11099a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "client" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "phone" integer, CONSTRAINT "PK_96da49381769303a6515a8785c7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "clientId" integer, CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "account" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying, "phone" integer, "password" character varying NOT NULL, "role" character varying NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "weatherstation_data" ADD CONSTRAINT "FK_853096ef2aee29be468a23fdd8b" FOREIGN KEY ("weatherstationId") REFERENCES "weatherstation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nearest_location" ADD CONSTRAINT "FK_b8058714adeb71a87a1c29f9e8d" FOREIGN KEY ("weatherstationId") REFERENCES "weatherstation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "nearest_location" DROP CONSTRAINT "FK_b8058714adeb71a87a1c29f9e8d"`);
        await queryRunner.query(`ALTER TABLE "weatherstation_data" DROP CONSTRAINT "FK_853096ef2aee29be468a23fdd8b"`);
