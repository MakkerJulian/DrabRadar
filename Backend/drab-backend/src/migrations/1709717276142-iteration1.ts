...
export class Iteration11709717276142 implements MigrationInterface {
  name = 'Iteration11709717276142';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "geolocation" ("id" SERIAL NOT NULL, "island" character varying, "county" character varying, "place" character varying, "hamlet" character varying, "town" character varying, "municipality" character varying, "state_district" character varying, "administrative" character varying, "state" character varying, "village" character varying, "region" character varying, "province" character varying, "city" character varying, "locality" character varying, "postcode" character varying, "weatherstationId" integer, "countryCode" character varying, CONSTRAINT "PK_36aa5f8d0de597a21a725ee1cc2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "geolocation" ADD CONSTRAINT "FK_1e9387ac1ff2ebea8bce79ef793" FOREIGN KEY ("weatherstationId") REFERENCES "weatherstation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "geolocation" DROP CONSTRAINT "FK_1e9387ac1ff2ebea8bce79ef793"`,
    );
    await queryRunner.query(
