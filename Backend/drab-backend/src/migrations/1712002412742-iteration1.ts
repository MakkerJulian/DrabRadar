...
export class Iteration11712002412742 implements MigrationInterface {
    name = 'Iteration11712002412742'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "customerId" integer, CONSTRAINT "REL_e4543f99d629cf2c04fe9332e3" UNIQUE ("customerId"), CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))`);
